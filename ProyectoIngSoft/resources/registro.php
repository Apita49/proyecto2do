...
<body>
	...
	<form action="Clientes_Registro" method="post">
		...
		<div class="col-2">
			<label> Profesión <input type ="text" 
			placeholder="Insertar profesión" name="profesion" tabindex="2">
			</label>
		</div>
		...
		<div class="col-5">
			...
			placeholder="Insertar dirección" name="direccion" tabindex="6">
			</label>
		</div>
